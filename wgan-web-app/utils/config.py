...
def parse_args():
    ...
    parser.add_argument('--dataset', type=str, default='mnist', choices=['mnist', 'fashion-mnist', 'cifar', 'stl10','animedata'],
...
def check_args(args):
    ...
    if args.dataset == 'cifar' or args.dataset == 'stl10' or args.dataset == 'animedata':
        args.channels = 3
    else:
        args.channels = 1
